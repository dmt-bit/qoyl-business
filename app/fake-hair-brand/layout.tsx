...
import { FakeHairBrandSessionProvider, useFakeHairBrandSession } from "@/lib/fakeHairBrandSession";
...
export default function FakeHairBrandLayout({ children }: { children: ReactNode }) {
  return (
    <FakeHairBrandSessionProvider>
...
function Sidebar() {
  ...
  const { account } = useFakeHairBrandSession();
